...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 09, 2023 lúc 03:17 PM
...
(4, 28, 49, '', '2023-12-09 06:28:17', 3),
(5, 28, 46, '', '2023-12-09 06:28:22', 5);
...
--
-- Cấu trúc bảng cho bảng `chi_tiet_bo_truyen`
--
...
--
-- Đang đổ dữ liệu cho bảng `chi_tiet_bo_truyen`
--
...
(109, 42, 120, 130000, '45 Ngày Biết Đệm Guitar - Tiết Điệu: Slow Fox-Disc', 1),
(110, 49, 121, 32000, 'Đại Ca ', 3),
(111, 46, 121, 130000, 'I Am Cat', 4),
(112, 48, 122, 55000, 'Truyện Cổ Tích Kinh Điển - Cô Bé Quàng Khăn Đỏ', 2);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `chi_tiet_don_hang_bo_truyen`
--
...
--
-- Đang đổ dữ liệu cho bảng `chi_tiet_don_hang_bo_truyen`
--
...
(120, 28, '2023-12-09 04:46:25', 1, ''),
(121, 28, '2023-12-09 06:27:54', 3, ''),
(122, 28, '2023-12-09 06:32:37', 1, '');
...
(92, 120, '20231209114623', 'Thanh toán khi nhận hàng', 0),
(93, 121, '20231209132548', 'vnpay', 1),
(94, 122, '20231209133236', 'Thanh toán khi nhận hàng', 0);
...
(42, '45 Ngày Biết Đệm Guitar - Tiết Điệu: Slow Fox-Disc', 'Theo Bộ Giáo dục và Đào tạo Việt Nam, đến năm học 2020 – 2021, cả nước có 42.080 cơ sở giáo dục từ n', 'amnhac.jpg', 130000, 159000, 148, 145, 11, '2023-08-16', '23', 3, '2023-11-28', 10, 2, 1),
...
(46, 'I Am Cat', 'Theo Bộ Giáo dục và Đào tạo Việt Nam, đến năm học 2020 – 2021, cả nước có 42.080 cơ sở giáo dục từ n', '2233.jpg', 130000, 139000, 120, 443, 16, '2023-11-10', '23', 3, '2023-11-28', 7, 1, 1),
...
(48, 'Truyện Cổ Tích Kinh Điển - Cô Bé Quàng Khăn Đỏ', 'Theo Bộ Giáo dục và Đào tạo Việt Nam, đến năm học 2020 – 2021, cả nước có 42.080 cơ sở giáo dục từ n', 'fs.jpg', 55000, 60000, 10, 32, 7, '2023-11-18', '23', 3, '2023-11-28', 12, 2, 1),
(49, 'Đại Ca ', 'Theo Bộ Giáo dục và Đào tạo Việt Nam, đến năm học 2020 – 2021, cả nước có 42.080 cơ sở giáo dục từ n', 'ft.jpg', 32000, 44000, 20, 312, 8, '2023-11-18', '23', 3, '2023-11-28', 10, 1, 1),
...
(28, 'duong2932004@gmail.com', '111', '0337684944', 'Nguyễn Thế Dương', 'user.jpg', 4, 1),
...
--
-- Chỉ mục cho bảng `chi_tiet_don_hang_bo_truyen`
--
...
--
ALTER TABLE `chatbox`
  MODIFY `id_msg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;

--
-- AUTO_INCREMENT cho bảng `chi_tiet_don_hang`
--
ALTER TABLE `chi_tiet_don_hang`
  MODIFY `id_chi_tiet_don_hang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;

--
-- AUTO_INCREMENT cho bảng `chi_tiet_don_hang_bo_truyen`
--
ALTER TABLE `chi_tiet_don_hang_bo_truyen`
...
--
ALTER TABLE `dia_chi`
  MODIFY `id_dia_chi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT cho bảng `don_hang`
--
ALTER TABLE `don_hang`
  MODIFY `id_don_hang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;

--
-- AUTO_INCREMENT cho bảng `gio_hang`
--
ALTER TABLE `gio_hang`
  MODIFY `id_gio_hang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT cho bảng `ho_don`
--
ALTER TABLE `ho_don`
  MODIFY `id_hoa_don` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
...
--
-- Các ràng buộc cho bảng `chi_tiet_don_hang_bo_truyen`
--
ALTER TABLE `chi_tiet_don_hang_bo_truyen`
