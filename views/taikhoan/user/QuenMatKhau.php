                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" class="alignment" style="line-height:10px">
                                                    <div style="max-width: 160px;"><a href="www.example.com" style="outline:none" tabindex="-1" target="_blank"><img alt="Your logo." src="http://duan1.totalh.net/logo.png" style="display: block; height: auto; border: 0; width: 100%;" title="Your logo." width="160"/></a></div>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                        <tr>
                                            <td class="pad" style="width:100%;">
                                                <div align="center" class="alignment" style="line-height:10px">
                                                    <div style="max-width: 640px;"><a href="www.example.com" style="outline:none" tabindex="-1" target="_blank"><img alt="Image of lock & key." src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/4036/___passwordreset.gif" style="display: block; height: auto; border: 0; width: 100%;" title="Image of lock & key." width="640"/></a></div>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
                                                <div style="color:#555555;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:30px;line-height:120%;text-align:center;mso-line-height-alt:36px;">
                                                    <p style="margin: 0; word-break: break-word;"><span style="color:#2b303a;"><strong>Bạn quên mật khẩu?</strong></span></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
                                                <div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:15px;line-height:150%;text-align:center;mso-line-height-alt:22.5px;">
                                                    <p style="margin: 0; word-break: break-word;"><span style="color:#808389;">Đừng lo lắng! Chúng tôi ở đây để giúp bạn khôi phục quyền truy cập tài khoản một cách nhanh chóng. Chúng tôi đã gửi một email chứa liên kết và hướng dẫn chi tiết đến địa chỉ email bạn đã đăng ký. Hãy nhấp vào nút bên dưới để bắt đầu quá trình đặt lại mật khẩu. Cảm ơn bạn đã tin tưởng và sử dụng dịch vụ của chúng tôi!.</span></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                        <tr>
                                            <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" class="alignment" style="line-height:10px">
                                                    <div class="fullWidth" style="max-width: 416px;"><a href="www.example.com" style="outline:none" tabindex="-1" target="_blank"><img alt="Your logo. " src="http://duan1.totalh.net/logo.png" style="display: block; height: auto; border: 0; width: 50%;margin-left: 12%;" title="Your logo. " width="416"/></a></div>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                                ...
                                                <div align="center" class="alignment">
                                                    <table border="0" cellpadding="0" cellspacing="0" class="social-table" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; display: inline-block;" width="208px">
                                                        <tr>
                                                            ...
                                                            <td style="padding:0 10px 0 10px;"><a href="https://www.twitter.com" target="_blank"><img alt="Twitter" height="32" src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/t-outline-circle-white/twitter@2x.png" style="display: block; height: auto; border: 0;" title="Twitter" width="32"/></a></td>
                                                            <td style="padding:0 10px 0 10px;"><a href="https://www.instagram.com" target="_blank"><img alt="Instagram" height="32" src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/t-outline-circle-white/instagram@2x.png" style="display: block; height: auto; border: 0;" title="Instagram" width="32"/></a></td>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:30px;padding-left:40px;padding-right:40px;padding-top:20px;">
                                                <div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:12px;line-height:120%;text-align:center;mso-line-height-alt:14.399999999999999px;">
                                                    ...
                                                    <p style="margin: 0; word-break: break-word;"><span style="color:#95979c;"> <a href="http://www.example.com" rel="noopener" style="text-decoration: underline; color: #ffffff;" target="_blank">Unsubscribe </a></span></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
